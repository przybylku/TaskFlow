...
export function RegisterForm() {
    ...
    return (
        <>
            ...
            <label htmlFor="username" className="mt-2">Nazwa</label>
            <Input {...register("username", {required: true})} />
            {errors.email && <span className="text-red-500">Nazwa jest wymagana!</span>}
            ...
            <Button loading={loading} type="submit" color="primary" style={{marginTop: "10px"}} className={" mt-5 hover:bg-primary focus:ring-2 shadow-lg transform active:scale-95 transition-transform"}>{loading ? "Szukanie konta.." : "Zaloguj się"}</Button>
            <p>Masz konto?<Link underline="hover" href={'/login'}> <LucideLink size={15} className="mr-1" />  Zaloguj się</Link></p>
